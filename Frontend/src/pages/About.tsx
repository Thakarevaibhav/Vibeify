...
desc: "Every contract, fee and rider — open book. No surprises, ever."
},
{
icon: Globe,
title: "Network",
desc: "Direct relationships with 100+ artists across India."
},
{
icon: Award,
title: "Proven Excellence",
desc: "Successfully delivering celebrity appearances, concerts, college fests, private events, government programs, and NGO initiatives."
},
{
icon: Heart,
title: "Personalized Attention",
desc: "A hands-on approach to every event, ensuring seamless coordination, clear communication, and exceptional execution from start to finish."
}
];
...
const About = () => (
  <>
    ...
    <PageHeader
      ...
      subtitle="Founded in 2018 in Nagpur, Vibeify has grown from a 3-person boutique into India's most trusted celebrity event company — booking 100+ events across 20+ cities."
    />
    ...
    <section className="py-20 container">
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="glass rounded-3xl p-10 space-y-6">
          ...
          <p className="text-2xl font-display leading-snug">
            To become India's most loved celebrity event agency — the bridge between iconic talent and people who deserve iconic moments.
          </p>
        </div>
      </div>
    </section>
